...
export default function TechStack() {
    ...
    const technologies = [
        { name: "React", color: "#61DAFB", size: 120 },
        { name: "Node.js", color: "#339933", size: 100 },
        { name: "Firebase", color: "#FFCA28", size: 110 },
        { name: "MongoDB", color: "#47A248", size: 105 },
        { name: "JavaScript", color: "#F7DF1E", size: 115 },
        { name: "Python", color: "#3776AB", size: 95 },
        { name: "SQL", color: "#4479A1", size: 90 },
        { name: "Next.js", color: "#000000", isDarkTextWhite: true, size: 110 }
    ]
    ...
    return (
        <section id="tech-stack" className="py-24 relative z-10 w-full overflow-hidden">
            ...
            <div
                ref={containerRef}
                className="clay-card hover:shadow-xl transition-shadow duration-500 w-full h-[600px] relative rounded-3xl overflow-hidden glass-panel"
            >
